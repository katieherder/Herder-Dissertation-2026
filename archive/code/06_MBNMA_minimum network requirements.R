...
# FIX: Rankings now use unified d_hat approach via corrected extract_metrics()
# from Chapter 4. All old results must be re-run.
#
# NEW: Section 5.4.4 — Network Connectivity simulation added.
#
